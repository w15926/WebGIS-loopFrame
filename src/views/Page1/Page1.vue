<template>
  <div class="Page1" ref="Page1">
    ...
    <template v-if="page1Config && page1Config.leftComponents">
      ...
      {'top': page1Config.leftContainerY ? page1Config.leftContainerY + 'px' : '160px'},
      {'left':  page1Config.leftContainerX ? page1Config.leftContainerX + 'px' : '40px'},
    ...
    <template v-if="page1Config && page1Config.absoluteComponents">
      <component v-for="(item, index) in page1Config.absoluteComponents" :receiveId="item.fileName + item.id" :key="index" :is="item.fileName" :fileCodes="item.fileCodes"
    ...
    <template v-if="page1Config && page1Config.centerComponets">
      ...
      {'overflow':  page1Config.centerContainerWidth || page1Config.centerContainerHeight ? 'hidden' : '' }
        ...
        <component v-for="(item, index) in page1Config.centerComponets" :receiveId="item.fileName + item.id" :key="index" :is="item.fileName" :fileCodes="item.fileCodes"
    ...
    <template v-if="page1Config && page1Config.rightComponents">
      ...
      {'top': page1Config.rightContainerY ? page1Config.rightContainerY + 'px' : '160px'},
      {'right':  page1Config.rightContainerX ? page1Config.rightContainerX + 'px' : '40px'},
